...
class RadarChart extends StatefulWidget {
  ...
  const RadarChart({
    ...
    this.axisColor = const Color(0xFFFFFFFF),
  ...
  factory RadarChart.dark({
    ...
    return RadarChart(
        ...
        data: data,
        featuresTextStyle:
            TextStyle(color: fontcolor.withOpacity(0.7), fontSize: 16),
        axisColor: const Color(0xFFE0E0E0).withOpacity(0.3),
        reverseAxis: reverseAxis,
        sides: useSides ? features.length : 0);
  }
...
class RadarChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (reverseAxis) {
      TextPainter(
        text: TextSpan(
          text: tickLabels[0].toString(),
        ),
        textDirection: TextDirection.ltr,
      )
        ..layout(minWidth: 0, maxWidth: size.width)
        ..paint(canvas, Offset(centerX, centerY - 20));
    }
    ...
    tickLabels
      ...
      // TextPainter(
      //   text: TextSpan(text: tick.toString()),
      //   textDirection: TextDirection.ltr,
      // )
      //   ..layout(minWidth: 0, maxWidth: size.width)
      //   ..paint(canvas, Offset(centerX, centerY - tickRadius - 20));
    });
    ...
    data.asMap().forEach((index, graph) {
      ...
      path.close();
      canvas.drawShadow(path, Colors.blue.withAlpha(50), 4.0, false);
