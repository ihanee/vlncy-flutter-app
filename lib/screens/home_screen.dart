            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //     text: "Apply Changes",
                  //     press: () {
                  //       mainUser['pref_age'] = [minAge.toInt(), maxAge.toInt()];
                  //       mainUser['pref_distance'] = [0, maxDistance];
                  //       // Update the labels of RangeSlider
                  //       setState(() {
                  //         // Update the labels of RangeSlider
                  //         minAge = mainUser['pref_age'][0].toDouble();
                  //         maxAge = mainUser['pref_age'][1].toDouble();
                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final distance = snapshot
                              .data?[index]; // Access the correct distance
